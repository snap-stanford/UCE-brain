...
- Data mix v3: `KuanP/brain-uce-pilot-mix-v3` (8 layers, 512 embedding dimension; 13-species designed mixture ("mixture C") of the v2026-09 corpus, 131,072 steps at global batch 512; gene dict `gene_data/all_species_gene_dict_v2026-09.json`, also shipped in the repo under `vocab/`)
